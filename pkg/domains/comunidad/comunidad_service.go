...
type ComunidadService interface {
	// Permisos
	GetPermisoComunidadService(filtro filtros.ComunidadFiltro) (bool, error)
...
func NewComunidadService(repo ComunidadRepository, util util.UtilService, commons commons.Commons) ComunidadService {
